...
if __name__ == "__main__":
    ...
    a = []
    data_path = '/media/zhl/本地磁盘/ResearchData/上海新华医院4类钼靶-2D/DataProcessing/crop_512/*.npy'
    ...
    reads = xlrd.open_workbook(
        '/media/zhl/本地磁盘/ResearchData/上海新华医院4类钼靶-2D/上海钼靶项目结果汇总/上海新华钼靶项目结果_v1.2/grouping_v1.7_414例_均衡样本.xlsx')
    id = []
    flag = []
    ...
    print('model load...')
    model_dir = "/media/zhl/本地磁盘/ResearchData/上海新华医院4类钼靶-2D/DataProcessing/leixian_forImage/mobilenet/huaxi/models_test"  # models4 130(0.74)
    ...
    train_dict = {'loss': []}
    val_dict = {'loss': [], 'auc': []}
    logger = logger.Logger('/media/zhl/本地磁盘/ResearchData/上海新华医院4类钼靶-2D/DataProcessing/leixian_forImage/mobilenet/huaxi/log')
    best_loss = 0
    for epoch in range(1, 500 + 1):
        ...
        if auc_test > 0.8 and auc_test < 0.83 and auc_vail > 0.8 and auc_vail < 0.85:
